...
Any engine, in any language, can validate its behavior against 494 spec files — 380 roster specs
...
| Layer | Description |
|-------|-------------|
| **YAML Specs** | 494 declarative spec files (380 roster + 114 GameData) covering all BattleScribe operations |
...
```
battlescribe-spec/
├── specs/                          # 494 YAML spec files (380 roster + 114 gamedata)
├── src/

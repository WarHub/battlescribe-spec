...
// Output
{"type":"errors","errors":[{"message":"Min 1 HQ required","entryId":"se-unit","constraintId":"con-min-1","raisedOnType":"category","raisedOnId":"cat-hq-node-1","raisedOnEntryId":"cat-hq"}]}
```
